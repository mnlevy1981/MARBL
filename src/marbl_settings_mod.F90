...
!*****************************************************************************
  ...
  subroutine marbl_settings_set_defaults_general_parms(unit_system)
    ...
    dust_per_unit_fesedflux       = 500.0_r8        ! CESM USERS - DO NOT CHANGE HERE! POP calls put_setting() for this var, see CESM NOTE above
    dust_per_unit_feventflux      = 25.0_r8         ! CESM USERS - DO NOT CHANGE HERE! POP calls put_setting() for this var, see CESM NOTE above
  ...
  subroutine marbl_settings_define_general_parms(this, marbl_status_log)
    ...
    if (base_bio_on) then
      ...
      lname     = 'Scale factor applied to POC burial coefficient to compute PON burial coefficient'
      units     = '1'
      datatype  = 'real'
      rptr      => PON_bury_coeff
      call this%add_var(sname, lname, units, datatype, category,       &
